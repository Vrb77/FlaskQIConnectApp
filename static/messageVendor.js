...
$(document).ready(function () {
    $("#contractDetForm").submit(function (event) {
      console.log("In on submit contractForm")
      event.preventDefault();
      var when = document.getElementById("when").value;
      var price = document.getElementById("price").value;
      var url = document.getElementById("urlForContractDetForm").value;
      console.log(url);
          ...
          success: function (response) {
            ...
            for (var i = messages.length - 1; i >= 0; i--) {
              ...
              if (response.From == message["from"]) {
                ...
                messageContent += '<div class="message-time">' + message["timestamp"].slice(11, 16) + '</div></div>' + '<br>';
